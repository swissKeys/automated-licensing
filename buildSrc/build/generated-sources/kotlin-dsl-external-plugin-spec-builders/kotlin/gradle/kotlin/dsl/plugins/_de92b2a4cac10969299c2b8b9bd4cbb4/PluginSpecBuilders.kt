...
package gradle.kotlin.dsl.plugins._de92b2a4cac10969299c2b8b9bd4cbb4
...
/**
 * The `dev.adamko` plugin group.
 */
@org.gradle.api.Generated
internal
class `DevAdamkoPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dev.adamko`.
 */
internal
val `DevPluginGroup`.`adamko`: `DevAdamkoPluginGroup`
    get() = `DevAdamkoPluginGroup`(plugins)


/**
 * The `dev.adamko.dokkatoo` plugin implemented by [dev.adamko.dokkatoo.DokkatooPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dokkatoo`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dokkatoo")


/**
 * The `dev.adamko.dokkatoo-gfm` plugin implemented by [dev.adamko.dokkatoo.formats.DokkatooGfmPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dokkatoo-gfm`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dokkatoo-gfm")


/**
 * The `dev.adamko.dokkatoo-html` plugin implemented by [dev.adamko.dokkatoo.formats.DokkatooHtmlPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dokkatoo-html`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dokkatoo-html")


/**
 * The `dev.adamko.dokkatoo-javadoc` plugin implemented by [dev.adamko.dokkatoo.formats.DokkatooJavadocPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dokkatoo-javadoc`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dokkatoo-javadoc")


/**
 * The `dev.adamko.dokkatoo-jekyll` plugin implemented by [dev.adamko.dokkatoo.formats.DokkatooJekyllPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dokkatoo-jekyll`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dokkatoo-jekyll")
...
/**
 * The `io.github.detekt` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubDetektPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.detekt`.
 */
internal
val `IoGithubPluginGroup`.`detekt`: `IoGithubDetektPluginGroup`
    get() = `IoGithubDetektPluginGroup`(plugins)


/**
 * The `io.github.detekt.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubDetektGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.detekt.gradle`.
 */
internal
val `IoGithubDetektPluginGroup`.`gradle`: `IoGithubDetektGradlePluginGroup`
    get() = `IoGithubDetektGradlePluginGroup`(plugins)


/**
 * The `io.github.detekt.gradle.compiler-plugin` plugin implemented by [io.github.detekt.gradle.DetektKotlinCompilerPlugin].
 */
internal
val `IoGithubDetektGradlePluginGroup`.`compiler-plugin`: PluginDependencySpec
    get() = plugins.id("io.github.detekt.gradle.compiler-plugin")
