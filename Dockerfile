...
RUN wget https://github.com/boyter/lc/releases/download/v1.3.1/lc-1.3.1-x86_64-unknown-linux.zip && \
    unzip lc-1.3.1-x86_64-unknown-linux.zip && \
    chmod +x lc

RUN curl -sSL https://get.haskellstack.org/ | sh

RUN npm install --global licensee
...
ARG JENKINS_VERSION=2.321
RUN wget http://mirrors.jenkins.io/war-stable/2.401.2/jenkins.war
...
# Run both Jenkins and ORT on container startup
ENTRYPOINT java -jar jenkins.war & /opt/ort/bin/ort